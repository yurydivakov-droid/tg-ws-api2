...
function getReplOverrides({ compatibilityFlags }) {
  const disabledByFlag = compatibilityFlags.includes(
...
function getV8Overrides({ compatibilityFlags }) {
  const disabledByFlag = compatibilityFlags.includes(
...
function getTtyOverrides({ compatibilityFlags }) {
  const disabledByFlag = compatibilityFlags.includes(
...
function getReadlineOverrides({ compatibilityFlags }) {
  const disabledByFlag = compatibilityFlags.includes(
...
function getPerfHooksOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_perf_hooks_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
